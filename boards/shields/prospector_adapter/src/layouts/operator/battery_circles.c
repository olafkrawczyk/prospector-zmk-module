...
void operator_battery_circles_battery_update_cb(struct battery_update_state state) {
    struct zmk_widget_operator_battery_circles *widget;
...
void operator_battery_circles_connection_update_cb(struct connection_update_state state) {
    struct zmk_widget_operator_battery_circles *widget;
    SYS_SLIST_FOR_EACH_CONTAINER(&widgets, widget, node) {
        if (widget->initialized) {
...
ZMK_DISPLAY_WIDGET_LISTENER(widget_operator_battery_circles_battery, struct battery_update_state,
                            operator_battery_circles_battery_update_cb, battery_circles_get_battery_state);
ZMK_SUBSCRIPTION(widget_operator_battery_circles_battery, zmk_peripheral_battery_state_changed);

ZMK_DISPLAY_WIDGET_LISTENER(widget_operator_battery_circles_connection, struct connection_update_state,
                            operator_battery_circles_connection_update_cb, battery_circles_get_connection_state);
ZMK_SUBSCRIPTION(widget_operator_battery_circles_connection, zmk_split_central_status_changed);

int zmk_widget_operator_battery_circles_init(struct zmk_widget_operator_battery_circles *widget, lv_obj_t *parent) {
    init_styles();
    ...
    widget_operator_battery_circles_battery_init();
    widget_operator_battery_circles_connection_init();
...
lv_obj_t *zmk_widget_operator_battery_circles_obj(struct zmk_widget_operator_battery_circles *widget) {
    return widget->obj;
}
