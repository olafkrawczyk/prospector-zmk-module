...
ZMK_LISTENER(widget_operator_output_endpoint, endpoint_changed_listener);
ZMK_SUBSCRIPTION(widget_operator_output_endpoint, zmk_endpoint_changed);

ZMK_LISTENER(widget_operator_output_profile, ble_active_profile_changed_listener);
ZMK_SUBSCRIPTION(widget_operator_output_profile, zmk_ble_active_profile_changed);
